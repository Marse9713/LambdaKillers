...
public class ABRTree
{
    ...
    public static class AlberoBinario
    {
        ...
        public Nodo ricerca(AlberoBinario albero, int valore)
        {
            return ricercaInAlbero(valore, radice);
        }

        public Nodo ricercaInAlbero(int valore, Nodo radice)
        {
            ...
            {
                return ricercaInAlbero(valore, radice.getNs());
            }
            else
            {
                return ricercaInAlbero(valore, radice.getNd());
            }
        }
