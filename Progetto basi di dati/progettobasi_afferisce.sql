...
CREATE TABLE `afferisce` (
  ...
  PRIMARY KEY (`id_dipartimento`,`id_progetto`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `afferisce`
--

LOCK TABLES `afferisce` WRITE;
/*!40000 ALTER TABLE `afferisce` DISABLE KEYS */;
/*!40000 ALTER TABLE `afferisce` ENABLE KEYS */;
UNLOCK TABLES;
