...
CREATE TABLE `occupa` (
  ...
  PRIMARY KEY (`id_ufficio`,`id_dipartimento`,`id_impiegato`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `occupa`
--

LOCK TABLES `occupa` WRITE;
/*!40000 ALTER TABLE `occupa` DISABLE KEYS */;
/*!40000 ALTER TABLE `occupa` ENABLE KEYS */;
UNLOCK TABLES;
